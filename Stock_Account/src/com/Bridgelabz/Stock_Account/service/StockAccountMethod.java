package com.Bridgelabz.Stock_Account.service;

import java.io.File;
import java.util.ArrayList;
import java.util.Scanner;

import com.Bridgelabz.Stock_Account.model.CompanyInfo;
import com.Bridgelabz.Stock_Account.model.CompanyModel;
import com.Bridgelabz.Stock_Account.model.CustomerInfo;
import com.Bridgelabz.Stock_Account.model.CustomerModel;
import com.Bridgelabz.Stock_Account.utility.JsonUtil;
...
public class StockAccountMethod {
	...
	public void buy(int amount,String symbol) {
		...
		for (int i = 0; i < customers.size(); i++) {
			...
			if(symbol.equals(companys.get(i).getSymbol())) {
